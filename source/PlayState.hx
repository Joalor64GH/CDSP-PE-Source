...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['Goofy ahh player', 0.2], //From 0% to 19%
		['O', 0.4], //From 20% to 39%
		['It is not overcharted, you are just bad', 0.5], //From 40% to 49%
		['Umm...', 0.6], //From 50% to 59%
		['IG', 0.69], //From 60% to 68%
		['N I C E', 0.7], //69%
		['Gucci', 0.8], //From 70% to 79%
		['GG', 0.9], //From 80% to 89%
		['Wowzers!', 1], //From 90% to 99%
		['Bravo!!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
	...
	override public function create()
	{
		...
		botplayTxt = new FlxText(400, timeBarBG.y + 55, FlxG.width - 800, "COUNTERRATIO", 32);
